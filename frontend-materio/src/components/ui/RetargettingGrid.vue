                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="ReturnCount">{{ val.returnCount }}</td>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Retargetting 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Retargetting 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Number label="ReturnCount" v-model="selectedRow.returnCount" :editMode="true"/>
...
import Retargetting from '../Retargetting.vue'
import String from '../primitives/String.vue'
import Number from '../primitives/Number.vue'

export default {
    name: 'retargettingGrid',
    mixins:[BaseGrid],
    components:{
        Retargetting,
        String,
