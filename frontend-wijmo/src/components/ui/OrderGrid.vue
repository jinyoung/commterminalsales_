<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','productId','options','customerId','address','insuranceOption',]" />
            ...
            <wj-flex-grid-column binding="insuranceOption" header="InsuranceOption" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
