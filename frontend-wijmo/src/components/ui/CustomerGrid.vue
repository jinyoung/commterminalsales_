<template>
    <div style="max-height:80vh;">
        ...
        <GetCustomer @search="search"></GetCustomer>
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','region','gender',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="region" header="Region" width="2*" :isReadOnly="true" align="center" />
