<template>
    <div>
        ...
        >
            ...
            <wj-flex-grid-column binding="options" header="Options" width="2*" :isReadOnly="!editMode" align="center"/>
            <wj-flex-grid-column binding="manufacturer" header="Manufacturer" width="2*" :isReadOnly="!editMode" align="center"/>
        </wj-flex-grid>
    </div>
</template>
