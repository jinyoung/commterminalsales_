<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','amount','product','customerId','paymentMethod',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="amount" header="Amount" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="product" header="Product" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="customerId" header="CustomerId" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="paymentMethod" header="PaymentMethod" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
