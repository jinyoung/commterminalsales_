...
export default {
    ...
    data: () => ({
        ...
        menus: [
            { id: 'spec', title: 'Spec',
                items: [
                    { key: 'specComparations', url: '/specComparations', name: '단말기 스펙 비교' },
                    { key: 'specs', url: '/specs', name: '단말기스펙' },
                ]
            },
            ...
            { id: 'marketing', title: 'Marketing',
                items: [
                    { key: 'retargettings', url: '/retargettings', name: 'Retargetting' },
                ]
            },
            { id: 'insurance', title: 'Insurance',
                items: [
                    { key: 'insuranceSubscriptions', url: '/insuranceSubscriptions', name: 'InsuranceSubscription' },
                ]
            },
            { id: 'payment', title: 'Payment',
                items: [
                    { key: 'payments', url: '/payments', name: 'Payment' },
                ]
            },
            { id: 'salesdashboard', title: 'Salesdashboard',
                items: [
                ]
            },
            { id: 'customer', title: 'Customer',
                items: [
                    { key: 'customers', url: '/customers', name: 'Customer' },
                    { key: 'messages', url: '/messages', name: 'Message' },
                ]
            },
        ],
        cards: [
            ...
            {
                text: "InsuranceSubscription",
                link: "/insuranceSubscriptions",
            },
            {
                text: "Payment",
                link: "/payments",
